/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 01e70516e3352d4f571b244001561e29)
// Runtime types generated with workerd@1.20260708.1 2026-05-28 nodejs_compat
interface __BaseEnv_Env {
	AUTH_DB: D1Database;
	EMAIL: SendEmail;
	AI: Ai;
	AUTH_PROVIDERS?: ["GOOGLE","GITHUB","EMAIL_PASSWORD"];
	BETTER_AUTH_URL?: "https://alpha.flowchat.app" | "https://flowchat.app";
	EMAIL_FROM: "noreply@flowchat.app";
	EMAIL_FROM_NAME: "FlowChat";
	BROWSER_RATE_LIMIT: true;
	IP_RATE_LIMIT: true;
	PROMPT_MAX_CHARACTERS: 20000 | 3000;
	VERIFY_EMAIL: true | false;
	FLOW_CHAT: DurableObjectNamespace<import("./src/index").FlowChat>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FlowChat";
	}
	interface AlphaEnv {
		AUTH_DB: D1Database;
		EMAIL: SendEmail;
		AI: Ai;
		AUTH_PROVIDERS: ["GOOGLE","GITHUB","EMAIL_PASSWORD"];
		BETTER_AUTH_URL: "https://alpha.flowchat.app";
		EMAIL_FROM: "noreply@flowchat.app";
		EMAIL_FROM_NAME: "FlowChat";
		BROWSER_RATE_LIMIT: true;
		IP_RATE_LIMIT: true;
		PROMPT_MAX_CHARACTERS: 20000;
		VERIFY_EMAIL: true;
		FLOW_CHAT: DurableObjectNamespace<import("./src/index").FlowChat>;
	}
	interface ProductionEnv {
		...
		AI: Ai;
		AUTH_PROVIDERS: ["GOOGLE","GITHUB","EMAIL_PASSWORD"];
		BETTER_AUTH_URL: "https://flowchat.app";
		EMAIL_FROM: "noreply@flowchat.app";
		EMAIL_FROM_NAME: "FlowChat";
		BROWSER_RATE_LIMIT: true;
		IP_RATE_LIMIT: true;
		PROMPT_MAX_CHARACTERS: 3000;
		VERIFY_EMAIL: false;
		FLOW_CHAT: DurableObjectNamespace<import("./src/index").FlowChat>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_PROVIDERS" | "BETTER_AUTH_URL" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "BROWSER_RATE_LIMIT" | "IP_RATE_LIMIT" | "PROMPT_MAX_CHARACTERS" | "VERIFY_EMAIL">> {}
}
declare module "*.css" {
	const value: string;
